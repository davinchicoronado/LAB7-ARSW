...
Los metodos POST, DELETE  y PUT no se implementaron para el archivo apimock  ya que estas operaciones no sirve sobre un archivo plano. Pero en cambio para apiclient
estas peticiones se realizaron debidamente.